...
class AnalyserPrompt(Prompt):
    def __init__(self, query: str, prev_results: list, action: Action):
        ...
        prompt += (f'Precondition: Below is the tool you can use (you can only use this tool). '
                   f'Now there is a user query: "{query}"\n'
                   f'Task: What you need to do is to generate values of parameters of the function\n'
    ...
    def invoke(self, model: BaseChatModel) -> dict:
